...
* Note onf 2020/02/02: experienced the problem between torchvision and pillow (https://github.com/pytorch/vision/issues/1712). Solved this by downgrading pillow: ```conda install "pillow<7"``` 
